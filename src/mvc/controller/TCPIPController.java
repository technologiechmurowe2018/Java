...
public class TCPIPController extends DataController{
	Socket connection;
	ObjectInputStream brinp; 
	String Token;
	public TCPIPController(String Adres,String Port,String token) throws NumberFormatException, UnknownHostException, IOException{
			Token=token;
